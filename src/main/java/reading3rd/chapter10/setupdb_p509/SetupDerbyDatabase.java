...
/**
 * execute command(Windows): java -cp "C:\Users\a859432\JDKs\jdk1.8.0_65\db\lib\derby.jar;target/Practice1Z0809-1.0-SNAPSHOT.jar" reading3rd.chapter10.setupdb_p509.SetupDerbyDatabase
 * execute command(Mac-OS): java -cp "/Library/Java/JavaVirtualMachines/jdk1.8.0_202.jdk/Contents/Home/db/db-derby-10.14.2.0-lib/lib/derby.jar:target/Practice1Z0809-1.0-SNAPSHOT.jar" reading3rd.chapter10.setupdb_p509.SetupDerbyDatabase
*/
